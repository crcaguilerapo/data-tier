...
public class Payment extends TableImpl<PaymentRecord> {
    ...
    /**
     * The reference instance of <code>db.payment</code>
     */
    ...
    /**
     * The column <code>db.payment.payment_id</code>.
     */
    public final TableField<PaymentRecord, Integer> PAYMENT_ID = createField(DSL.name("payment_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>db.payment.user_id</code>.
     */
    public final TableField<PaymentRecord, Integer> USER_ID = createField(DSL.name("user_id"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>db.payment.amount</code>.
     */
    public final TableField<PaymentRecord, BigDecimal> AMOUNT = createField(DSL.name("amount"), SQLDataType.DECIMAL(10, 2).nullable(false), this, "");

    /**
     * The column <code>db.payment.payment_date</code>.
     */
    public final TableField<PaymentRecord, LocalDateTime> PAYMENT_DATE = createField(DSL.name("payment_date"), SQLDataType.LOCALDATETIME(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>db.payment.status</code>.
     */
    public final TableField<PaymentRecord, String> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR(20).nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>db.payment</code> table reference
     */
    ...
    /**
     * Create a <code>db.payment</code> table reference
     */
    public Payment() {
