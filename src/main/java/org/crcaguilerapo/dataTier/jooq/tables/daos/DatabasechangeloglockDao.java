...
public class DatabasechangeloglockDao extends DAOImpl<DatabasechangeloglockRecord, jooq.tables.pojos.Databasechangeloglock, Integer> {

    /**
     * Create a new DatabasechangeloglockDao without any configuration
     */
    public DatabasechangeloglockDao() {
        super(Databasechangeloglock.DATABASECHANGELOGLOCK, jooq.tables.pojos.Databasechangeloglock.class);
    }
    ...
    public DatabasechangeloglockDao(Configuration configuration) {
        super(Databasechangeloglock.DATABASECHANGELOGLOCK, jooq.tables.pojos.Databasechangeloglock.class, configuration);
    }

    @Override
    public Integer getId(jooq.tables.pojos.Databasechangeloglock object) {
        return object.getId();
    }
     ...
     * upperInclusive</code>
     */
    public List<jooq.tables.pojos.Databasechangeloglock> fetchRangeOfId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<jooq.tables.pojos.Databasechangeloglock> fetchById(Integer... values) {
     ...
     */
    public jooq.tables.pojos.Databasechangeloglock fetchOneById(Integer value) {
     ...
     * Fetch a unique record that has <code>ID = value</code>
     */
    public Optional<jooq.tables.pojos.Databasechangeloglock> fetchOptionalById(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<jooq.tables.pojos.Databasechangeloglock> fetchRangeOfLocked(Byte lowerInclusive, Byte upperInclusive) {
     ...
     */
    public List<jooq.tables.pojos.Databasechangeloglock> fetchByLocked(Byte... values) {
     ...
     * upperInclusive</code>
     */
    public List<jooq.tables.pojos.Databasechangeloglock> fetchRangeOfLockgranted(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<jooq.tables.pojos.Databasechangeloglock> fetchByLockgranted(LocalDateTime... values) {
     ...
     * upperInclusive</code>
     */
    public List<jooq.tables.pojos.Databasechangeloglock> fetchRangeOfLockedby(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<jooq.tables.pojos.Databasechangeloglock> fetchByLockedby(String... values) {
